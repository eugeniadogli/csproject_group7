...
class AdminDashboard(tk.Frame):
    def __init__(self,main,adminame):  #tk Frame acts as the parent class for AdminDashboard, inheritting it's functions!
        self.main = main
        self.adminame = adminame
        #use of self.main because main is or window dashboard

        self.main.title(f"Gridcare-Lite - Hello, Admin {self.adminame}")
...
'''
main = tk.Tk()
dashboard = AdminDashboard(main, "Eugenia") #ok, username has to be gotten from the login window but hard coded for now/
